...
# python experiment_scripts/benchmark_search.py -m PACMAP-H \
# --no-learn --data-path small_datasets -all -q 0.1 -e 0.1 -dt "$DATETIME" \
# --eta 0.1 0.3 0.5 \
# --n-batch 5 10 20 
...
python experiment_scripts/benchmark_search.py -m PACMAP-H \
--no-learn --data-path small_datasets -all -q 0.25 -e 0.25 -dt "$DATETIME" \
--eta 0.1 0.3 0.5 \
--n-batch 5 10 20 
...
python experiment_scripts/benchmark_search.py -m PACMAP-H \
--no-learn --data-path small_datasets -all -q 0.4 -e 0.4 -dt "$DATETIME" \
--eta 0.1 0.3 0.5 \
--n-batch 5 10 20 
