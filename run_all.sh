...
python experiment_scripts/benchmark.py -m MP AMP MS HBP PACMAP PACMAP-H PACMAP-TopK --no-learn --data-path small_datasets -all -q 0.1 -e 0.1 -dt "$DATETIME" --eta 0.3
...
python experiment_scripts/benchmark.py -m MP AMP MS HBP PACMAP PACMAP-H PACMAP-TopK --no-learn --data-path small_datasets -all -q 0.25 -e 0.25 -dt "$DATETIME" --eta 0.3
...
python experiment_scripts/benchmark.py -m MP AMP MS HBP PACMAP PACMAP-H PACMAP-TopK --no-learn --data-path small_datasets -all -q 0.4 -e 0.4 -dt "$DATETIME" --eta 0.3
